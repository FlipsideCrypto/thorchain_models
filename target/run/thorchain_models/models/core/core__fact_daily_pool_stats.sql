      ...
      create or replace transient table THORCHAIN_DEV.core.fact_daily_pool_stats copy grants as
      (select * from(
...
FROM
  base A
    ...
    alter table THORCHAIN_DEV.core.fact_daily_pool_stats cluster by (day);