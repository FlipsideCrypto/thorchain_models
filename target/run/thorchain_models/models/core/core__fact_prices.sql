      ...
      create or replace transient table THORCHAIN_DEV.core.fact_prices copy grants as
      (select * from(
...
FROM
  ...
  ON A.block_id = b.block_id
    ...
    alter table THORCHAIN_DEV.core.fact_prices cluster by (block_timestamp::DATE);