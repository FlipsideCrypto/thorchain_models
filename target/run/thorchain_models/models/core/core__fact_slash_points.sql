      ...
      create or replace transient table THORCHAIN_DEV.core.fact_slash_points copy grants as
      (select * from(
...
FROM
  ...
  ON A.block_timestamp = b.timestamp
    ...
    alter table THORCHAIN_DEV.core.fact_slash_points cluster by (block_timestamp::DATE);