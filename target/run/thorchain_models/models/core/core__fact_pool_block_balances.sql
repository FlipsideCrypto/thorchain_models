      ...
      create or replace transient table THORCHAIN_DEV.core.fact_pool_block_balances copy grants as
      (select * from(
...
FROM
  ...
  ON A.block_id = b.block_id
    ...
    alter table THORCHAIN_DEV.core.fact_pool_block_balances cluster by (block_timestamp::DATE);