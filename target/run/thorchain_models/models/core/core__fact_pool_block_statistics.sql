      ...
      create or replace transient table THORCHAIN_DEV.core.fact_pool_block_statistics copy grants as
      (select * from(
...
FROM
  base A
    ...
    alter table THORCHAIN_DEV.core.fact_pool_block_statistics cluster by (day);