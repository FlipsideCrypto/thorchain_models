      ...
      create or replace transient table THORCHAIN_DEV.core.fact_upgrades copy grants as
      (select * from(
...
FROM
  ...
  ON A.block_id = b.block_id
    ...
    alter table THORCHAIN_DEV.core.fact_upgrades cluster by (block_timestamp::DATE);