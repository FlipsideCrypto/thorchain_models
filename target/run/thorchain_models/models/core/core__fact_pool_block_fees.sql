      ...
      create or replace transient table THORCHAIN_DEV.core.fact_pool_block_fees copy grants as
      (select * from(
...
FROM
  base A
    ...
    alter table THORCHAIN_DEV.core.fact_pool_block_fees cluster by (day);