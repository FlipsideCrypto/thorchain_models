      ...
      create or replace transient table THORCHAIN_DEV.core.fact_add_events copy grants as
      (select * from(
...
FROM
  ...
  ON A.block_timestamp = b.timestamp
    ...
    alter table THORCHAIN_DEV.core.fact_add_events cluster by (block_timestamp::DATE);