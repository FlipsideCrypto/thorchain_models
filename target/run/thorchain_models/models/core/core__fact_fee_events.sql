      ...
      create or replace transient table THORCHAIN_DEV.core.fact_fee_events copy grants as
      (select * from(
...
FROM
  ...
  ON A.block_timestamp = b.timestamp
    ...
    alter table THORCHAIN_DEV.core.fact_fee_events cluster by (block_timestamp::DATE);