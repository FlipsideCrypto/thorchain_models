  ...
  create or replace  view THORCHAIN_DEV.silver.pending_liquidity_events
...
(
    ...
    "ASSET_BLOCKCHAIN" COMMENT $$$$, 
  
    "ASSET_ADDRESS" COMMENT $$$$, 
  
    "ASSET_E8" COMMENT $$$$, 
  
    "RUNE_TX_ID" COMMENT $$$$, 
  
    "RUNE_ADDRESS" COMMENT $$$$, 
  
    "RUNE_E8" COMMENT $$$$, 
  
    "PENDING_TYPE" COMMENT $$$$, 
