      ...
      create or replace transient table THORCHAIN_DEV.silver.total_value_locked copy grants as
      (select * from(
...
FROM
  ...
  ON total_value_bonded_tbl.day = total_value_pooled_tbl.day
    ...
    alter table THORCHAIN_DEV.silver.total_value_locked cluster by (day);