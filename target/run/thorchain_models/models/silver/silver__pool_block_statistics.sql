      ...
      create or replace transient table THORCHAIN_DEV.silver.pool_block_statistics copy grants as
      (select * from(
...
FROM
  joined
    ...
    alter table THORCHAIN_DEV.silver.pool_block_statistics cluster by (day);