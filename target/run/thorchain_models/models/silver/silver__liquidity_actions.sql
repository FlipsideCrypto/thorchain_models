      ...
      create or replace transient table THORCHAIN_DEV.silver.liquidity_actions copy grants as
      (select * from(
...
FROM
  ...
  AND ue.pool_name = p.pool_name
    ...
    alter table THORCHAIN_DEV.silver.liquidity_actions cluster by (_inserted_timestamp::DATE);