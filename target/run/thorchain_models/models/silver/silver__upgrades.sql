      ...
      create or replace transient table THORCHAIN_DEV.silver.upgrades copy grants as
      (select * from(
...
FROM
  ...
  ON b.height = p.block_id
    ...
    alter table THORCHAIN_DEV.silver.upgrades cluster by (_inserted_timestamp::DATE);