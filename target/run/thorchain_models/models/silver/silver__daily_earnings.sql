      ...
      create or replace transient table THORCHAIN_DEV.silver.daily_earnings copy grants as
      (select * from(
...
FROM
  ...
  ON br.day = drp.day
    ...
    alter table THORCHAIN_DEV.silver.daily_earnings cluster by (_inserted_timestamp::DATE);